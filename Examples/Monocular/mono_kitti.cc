...
// ./mono_kitti ../Vocabulary/ORBvoc.txt ../Examples/Monocular/KITTI00-02.yaml /home/zxq/Downloads/data/slam/odometry/00/
int main(int argc, char **argv)
{
    ...
    vector<double> vTimestamps;
    // argv[3]是Frame的路径，单目数据集图片（也就是Frames）load进来
